   ...
   <head>
    ...
    link2 = "<a href='operacoesProdutos'><li>Operacoes</li></a>";
     ...
     <div class="box">
        ...
        <div ><h2 class="nomeIniciar">Contacte-nos</h2></div>
...
<table  border="0" align="center" id="form">
  <tbody>
    ...
    <tr>
      ...
      <td >
        <input type="text" name="apelido" class="insert" required="true" autofocus placeholder="Apelido" />
      </td>
    </tr>
    <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
    <tr>
        ...
        <td >
        <input type="email" name="email" class="insert" required="true" autofocus placeholder="xyz@email.com"/>
      </td>
    </tr>
    <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
    <tr>
        <td align="center" class="insertText" >  Comentario: </td>
        <td >
            <textarea type="email" name="email"  required="true" autofocus placeholder="Escreve seu comentario..."></textarea>
      </td>
    </tr>
     <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
    <tr>
