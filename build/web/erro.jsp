   ...
   <head>
    ...
    link2 = "<a href='operacoesProdutos'><li>Operacoes</li></a>";
     ...
     <div class="box">
        ...
        <div ><h2 class="nomeIniciar">Iniciar Sessao</h2>
            <h4 id="erro">Dados incorrectos | Insira os dados novamente</h4></div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><input class="btn" type="submit" name="submit" value="Entrar"></td>
        ...
        <img src="img/email_icon.png" width="25px" height="15px" class="insertText" style="position: absolute; top:390px; left: 510px;"/>
         <img src="img/password_icon.png" width="18px" height="25px" class="insertText" style="position: absolute; top:438px; left: 515px;"/>
</body>
</html>
