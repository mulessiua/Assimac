    ...
    link2 = "<a href='operacoesProdutos'><li>Operacoes</li></a>";
        ...
        <% produtos = (ArrayList<Produto>) request.getAttribute("produtos");%>
         ...
         out.println("<table  border='0'   class='teste' background='img/symphony.png'>");
            ...
            for(Produto p: produtos){
                  ...
                  if(i>=0){
                out.println("<td id ='grid' width='180' height='260'bgcolor='white' >"
                        ...
                        + "<p align=center><a class='btn' href='apagarProduto?produtoId="+p.getProdutoId()+"'>Apagar<a/> | "
                        + " <a class='btn' href='editarProduto?produtoId="+p.getProdutoId()+"'>Editar<a/></p>"
                        + "</td>"
     ...
     <div class="box">
         <div class="container-4">
             <form action="Eprocurar" method="get"> 
